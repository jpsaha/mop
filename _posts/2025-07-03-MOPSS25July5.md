...
{% include yml.html title="RMO2017aP2" com="rmo" yr="rmo2017a" pr="p2" type="eg" %}
...
{% include yml.html title="RMO1998P2" com="rmo" yr="rmo1998" pr="p2" type="eg" %}
{% include yml.html title="RMO1998P2Watru" content=site.data.rmo.rmo1998.p2 type="watru" %}

{% include yml.html title="RMO2023aP2" com="rmo" yr="rmo2023a" pr="p2" type="eg" %}
{% include yml.html title="RMO2023aP2Watru" content=site.data.rmo.rmo2023a.p2 type="watru" %}

{% include yml.html title="RMO2023bP1" com="rmo" yr="rmo2023b" pr="p1"  type="eg" %}
