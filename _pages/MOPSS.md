...
<!-- Here is [the flyer](../assets/pdf/MOPSS/flyer25A.pdf). -->
...
> | <i class="fas fa-calendar-alt" style="color:gray"></i> **23rd August, 2025** |  <a href="{{ '.pdf' | prepend: 'MOPSS25Aug23' | prepend: 'MOPSS/' | prepend: 'assets/pdf/' | relative_url }}" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-file-pdf fa-2x"></i></a> |    [<i class="fa-solid fa-globe fa-2x"></i>]({{ site.url }}{{ site.baseurl }}/blog/2025/MOPSS25Aug23/)     |
...
<!--
> [<i class="fa-solid fa-download"></i> Click here]({{ site.url }}{{ site.baseurl }}/blog/2025/MOPSS25July5/) to download the Problem Set of <a href="../MOPSS/">MOPSS</a> held **5th July, 2025.**
-->
